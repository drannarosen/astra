...
function outer_boundary_row_summary(
    ...
    outer_transport_terms = _ASTRA_MODULE.transport_row_terms(problem, model, n - 1)
    ...
    return _ASTRA_MODULE.OuterBoundaryRowSummary(
        ...
        outer_transport_terms.transport_regime,
        outer_transport_terms.transport_guarded,
        outer_transport_terms.nabla_radiative,
        outer_transport_terms.nabla_ledoux,
        outer_transport_terms.nabla_transport,
        outer_transport_terms.superadiabatic_excess,
        outer_transport_terms.convective_velocity_cm_s,
        outer_transport_terms.convective_flux_fraction,
        outer_transport_raw,
        ...
        fitting_point_terms.current_match_pressure_dyn_cm2,
        fitting_point_terms.fitting_point_pressure_dyn_cm2,
        fitting_point_terms.pressure_contract_log_gap,
        pressure_semantics.surface_pressure_dyn_cm2,
    ...
    for k in 1:(n - 1)
        ...
        if abs(weighted_contribution) > best_abs_weighted
            ...
            best_summary = _ASTRA_MODULE.TransportHotspotSummary(
                ...
                row_index,
                transport_terms.transport_regime,
                transport_terms.transport_guarded,
                raw_residual,
                row_weight,
                weighted_contribution,
                transport_terms.delta_log_temperature,
                transport_terms.delta_log_pressure,
                transport_terms.nabla_radiative,
                transport_terms.nabla_ledoux,
                transport_terms.nabla_transport,
                transport_terms.superadiabatic_excess,
                transport_terms.convective_velocity_cm_s,
                transport_terms.convective_flux_fraction,
