...
Use [Progress Summary](progress-summary.md) for dated executive TL;DR entries. Each entry should explain what changed, why it mattered, what was verified, and what comes next.
