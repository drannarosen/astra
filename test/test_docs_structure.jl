@testset "docs structure" begin
    ...
    contract_docs = Dict(
        ...
        "docs/website/development/progress-summary.md" => [
            ...
            "match_to_photosphere_log_gap = 0.0",
            "temperature is photospheric",
            ...
            "saved ZAMS remains deferred as a later control lane",
            "2026-03-30-surface-owner-localization-audit",
            "all four focused cases",
            "accepted_dominant_surface_family = surface_pressure",
            "outer transport hotspot stays on the outer row at cell index `11`",
        ...
        "docs/website/development/checklists/solar-first-lane.md" => [
            ...
            "outer transport row remains one-sided to the photospheric face",
            "diagnostic-only PMS-like seed comparison",
        ],
        "docs/website/development/issues.md" => [
            "Active issues",
        ...
        "docs/website/physics/atmosphere-and-photosphere.md" => [
            ...
            "temperature bridge is now photospheric",
            "converged = false",
            "surface-owned",
        ],
        "docs/website/physics/stellar-structure/mass-conservation.md" => [
